        ...
        try {
            ...
            if (args[0] === undefined || "")
                return message.channel.send({
                    embeds: [
                        Embeds.errorCode("Usuario Invalido.", "Foi encontrado, no comando de remover usuarios, um erro de Sintaxe. Caso esteja com duvidas de como usar, por favor, siga as instruções abaixo: ", "userdelete", [
                            {
            ...
            message.channel.send({ embeds: [embedLoading] }).then(async (loading) => {
                ...
                await loading.delete();
                let userlDeleteSucess = new discord_js_1.MessageEmbed()
                    .setTitle("**⭕ Usuario Removido ⭕**")
                    .setAuthor(`Peach`, "https://media.discordapp.net/attachments/776094611470942208/846246640867737610/peach_san.png")
                    .setColor("#a142f5");
                message.channel
