...
const discordjs_button_pagination_1 = __importDefault(require("discordjs-button-pagination"));
...
exports.command = {
    ...
    run: async (client, message, args) => {
        try {
            const developerMessage = new discord_js_1.MessageEmbed()
                .setTitle("**Ajuda ➔**")
                .setAuthor({
                ...
                .setDescription(" Olá sou seu bot focado na administração desse servidor. Eu ainda estou em desenvolvimento então erros ou bugs inesperados podem acontecer, no entanto, se caso acontecer, contate o desenvolvedor do bot.")
            ...
            const helpEmbed = new discord_js_1.MessageEmbed()
                ...
                .setColor("#ff57fc")
                .setDescription(`Olá ${message.author.username}, Logo abaixo, estão listadas todas as minhas funcionalidades. Qualquer tipo de duvida, entre em contato com os moderadores ou com o Desenvolvedor do bot.`)
                .addFields({ name: "**│ 🡻 Administração 🡻 │**", value: "\u200b" }, {
            ...
            //   },
            {
                ...
                value: "`.profile {user❌}`",
            }, { name: "Comando para limpar o chat.", value: "`.clear {number✅}`" }, { name: "\u200b", value: "\u200b" }, {
                name: "**│ 🡻 Parametros obrigatórios e opcionais 🡻 │**",
                value: "`✅` ➟ Preenchimento Obrigatório; `❌` ➟ Preenchimento Opcional;",
            }, 
            //➤
            {
                name: "**│ ➤ Comando para bufadores ➤ │**",
                value: `Version ${package_json_1.version}`,
            });
            const boosterEmbed = new discord_js_1.MessageEmbed()
                .setAuthor({
                name: `${message.client.user.username} ➔ Comando para bufadores 🎉🔰`,
                iconURL: `${message.client.user.avatarURL()}`,
            })
                .setColor("#9b61ff")
                .setDescription(`Já ouviu falar dos comandos exclusivos para bufadores, ${message.author.username}? Não seja por isso, aqui estão alguns deles:`)
                .addFields({ name: "**│ 🡻 BUFADORES 🡻 │**", value: "\u200b" }, {
                ...
                name: "**│ 🡻 OBSERVAÇÃO 🡻 │**",
                value: "`Lembrando que toda 00:xx são re-inteirados 2 mutes para cada bufador do servidor; Para os membros que usavam os apelidos para os comandos(.useradd -> .ua) o comando funcionará normalmente independente dos metodos usados.`",
            }, {
                name: "**│ ➤ Como usar os parâmetros ➤ │**",
                value: `Version ${package_json_1.version}`,
            });
            const parametersEmbed = new discord_js_1.MessageEmbed()
                .setAuthor({
                name: `${message.client.user.username} ➔ Parâmetros dos comandos`,
                iconURL: `${message.client.user.avatarURL()}`,
            })
                .setColor("#fcdb03")
                .setDescription(`Para usar o bot adequadamente, é preciso saber como preencher os parâmetros, ${message.author.username}. Aqui está uma aulinha rapida:`)
                .addFields({ name: "**│ 🡻 Parametros 🡻 │**", value: "\u200b" }, {
                name: ":grey_exclamation: {user}",
                value: "`@Discord ou 261945904829956097(ID do usuario)` 🡻",
            }, {
                name: ":grey_exclamation: {time}",
                value: "`(s ➟ seconds; m ➟ minutes; h ➟ hour; d ➟ days) Exemplo: 1h; 10m; 24d(1 hora, 10 minutos e 24 dias)` 🡻",
            }, {
            ...
            (0, discordjs_button_pagination_1.default)(message, pages, buttonList, timeout);
